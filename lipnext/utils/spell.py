# Spell correction and untokenizer, by Rizkiarm
# Source: https://github.com/rizkiarm/LipNet/blob/master/lipnet/utils/spell.py
...
class Spell(object):
    def __init__(self, path):
        self.dictionary = Counter(list(string.punctuation) + Spell.words(open(path).read()))
    ...
    def candidates(self, word):
        ...
        return self.known([word]) or self.known(Spell.edits1(word)) or self.known(Spell.edits2(word)) or [word]
    ...
    def edits2(word):
        ...
        return (e2 for e1 in Spell.edits1(word) for e2 in Spell.edits1(e1))
