...
class Decoder(object):
	...
	def __init__(self, greedy: bool = True, beam_width: int = 200, top_paths: int = 1, postprocessors: list = []):
		self.greedy         = greedy
	...
	def __keras_decode(self, y_pred: np.ndarray, input_lengths: np.ndarray, greedy: bool, beam_width: int, top_paths: int) -> list:
